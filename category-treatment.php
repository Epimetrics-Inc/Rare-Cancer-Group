<?php
/* Resources page: Treatment */

get_header(); ?>

<main class="resources" id="treatment">
  <!-- HERO BANNER -->
  <section class="hero-banner text-only">
    <div class="hero-text">
      <h1>Treatment</h1>
      <div class="hero-description">
        <p>A quick description on what treatment pertains to, maybe? Or something else entirely. I’m not sure. Made this based on my understanding of what was needed.</p>
