<?php
/* Resources page: Survivorship */

get_header(); ?>

<main class="resources" id="survivorship">
  <!-- HERO BANNER -->
  <section class="hero-banner text-only">
    <div class="hero-text">
      <h1>Survivorship</h1>
      <div class="hero-description">
        <p>A quick description on what survivorship pertains to, maybe? Or something else entirely. I’m not sure. Made this based on my understanding of what was needed.</p>
        <p>Can have a second paragraph, too. It can also be a short one at that.</p>
      </div>
    </div>
  </section>
