<?php
/* Resources page: Legacy */

get_header(); ?>

<main class="resources" id="legacy">
  <!-- HERO BANNER -->
  <section class="hero-banner text-only">
    <div class="hero-text">
      <h1>Legacy</h1>
      <div class="hero-description">
        <p>A quick description on what legacy pertains to, maybe? Or something else entirely. I’m not sure. Made this based on my understanding of what was needed.</p>
